...
Control<-c( 1104, 1072, 1088, 1328, 1376, 1280, 1120, 120)
...
t.test(Fertilizante,Control,var.equal = FALSE,conf.level = 0.95)

OneTwoSamples::interval_estimate5(Fertilizante,Control,sigma=c(-1,-1),var.equal = FALSE,alpha = 0.05)
```
